...
/**
思路：
阶乘后0的数量，取决于阶乘中能提供2和5的数量。
又因为所有偶数是2的乘积，2的数量会比5多得多。
所以核心在于5的数量。

对于125!，即[125 * 124 * 123 * ... * 5 * 4* 3 * 2 * 1]来说，
能提供1个5数的有：5的倍数的个数，如5，10， 20，...，即第一轮，divisor = 5 时，n 中有多少个 divisor
能提供2个5的数有：5 * 5即25的倍数的个数，如25，50，100...，这些数比5的倍数【额外】多提供一个5，即第二轮，divisor = 25 时，n 中有多少个 divisor
